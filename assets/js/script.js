document.addEventListener('DOMContentLoaded', () => {
    ...
    // CTA Buttons (Monkey and Hamster)
    const buyMonkeyBtn = document.querySelector('.js-buy-monkey');
    if (buyMonkeyBtn) {
        buyMonkeyBtn.addEventListener('click', (e) => {
            e.preventDefault();
            alert('Tyvärr, aporna är slut för i år! 🎅🐒');
        });
    }

    const buyHamsterBtn = document.querySelector('.js-buy-hamster');
    if (buyHamsterBtn) {
        buyHamsterBtn.addEventListener('click', (e) => {
             e.preventDefault();
